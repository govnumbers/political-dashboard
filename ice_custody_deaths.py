...
# (FY2025's ceiling was set under the prior administration; US Refugee Admissions Program was suspended
...
def main():
    ...
    out = {
        ...
        "note": f"Refugees admitted FY{fy} to date, from the State Department's monthly "
                ...
                "court-ordered and follow-to-join cases sit outside it. US Refugee Admissions Program was suspended "
