#!/usr/bin/env python3
"""Electricity price (residential, US city average), Bureau of Labor Statistics via FRED (keyless).

APU000072610 = Bureau of Labor Statistics average price, electricity per kWh, US city average (NSA , 
...
def main():
    ...
    out = {
        ...
        "cadence": "Monthly",
        "note": "US city average residential price per kilowatt-hour (Bureau of Labor Statistics average-price "
