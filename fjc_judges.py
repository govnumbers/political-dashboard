#!/usr/bin/env python3
"""Medicaid & Children's Health Insurance Program enrollment, Centers for Medicare & Medicaid Services via the data.medicaid.gov open API
(keyless JSON, DKAN datastore).

Verified structure (Jul 2026): dataset 6165f45b-ca93-5bb5-9d06-db29c692a360
("State Medicaid and Children's Health Insurance Program Applications, Eligibility Determinations, and
...
def main():
    ...
    out = {
        "id": "medicaid_enrollment", "name": "Medicaid & Children's Health Insurance Program enrollment",
        ...
        "note": "Total people enrolled in Medicaid and Children's Health Insurance Program, summed from state reports to Centers for Medicare & Medicaid Services "
