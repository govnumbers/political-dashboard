#!/usr/bin/env python3
"""Drug overdose deaths (trailing 12 months, provisional), Centers for Disease Control and Prevention NCHS Vital
...
for recent months), predicted_value (Centers for Disease Control and Prevention's completeness-adjusted estimate).

USE predicted_value, reported counts for recent months are systematically low
because investigations are pending (Centers for Disease Control and Prevention's own guidance). ~5-month publication
...
def main():
    ...
    if not series:
        raise RuntimeError("parsed zero overdose points from Centers for Disease Control and Prevention VSRR")
    ...
    out = {
        ...
        "source": {"name": "Centers for Disease Control and Prevention, NCHS provisional overdose counts",
                   "url": "https://www.cdc.gov/nchs/nvss/vsrr/drug-overdose-data.htm"},
        "cadence": "Monthly", "stale_days": 240,
        "note": "Provisional Centers for Disease Control and Prevention estimate (completeness-adjusted) of overdose deaths in the 12 "
