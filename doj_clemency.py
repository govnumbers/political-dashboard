...
GASREGW is the Energy Information Administration's weekly U.S. regular all-formulations retail gasoline price,
...
data is still Energy Information Administration; FRED is just the keyless delivery.)"""
import os
import sys
import csv
import io
