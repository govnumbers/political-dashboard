#!/usr/bin/env python3
"""US crude oil production, Energy Information Administration (keyless), monthly, history to 1920.
...
SOURCE MECHANICS: Energy Information Administration's open-data API requires a registration key (rejected , 
...
creator-download fallback stands if Energy Information Administration ever blocks the runner.
...
def main():
    ...
    out = {
        ...
        "source": {"name": "U.S. Energy Information Administration",
                   "url": "https://www.eia.gov/dnav/pet/hist/LeafHandler.ashx?n=PET&s=MCRFPUS2&f=M"},
        "cadence": "Monthly",
        "note": "US field production of crude oil, million barrels per day (Energy Information Administration monthly, "
