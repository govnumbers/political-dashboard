...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  @media (max-width:665px) {{
    ...
    .fz-table td {{ border-bottom:0; padding:18px 0 0; }}
    .fz-note {{ grid-column:1 / -1; padding:7px 0 20px; margin:0; max-width:none;
               border-bottom:1px solid var(--hair-strong); }}
    .fz-table tbody tr:last-child .fz-note {{ border-bottom:0; padding-bottom:2px; }}
  }}
</style>
</head>
<body>
