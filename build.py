...
<style>
  :root {{
    ...
    /* president identity palette (card-design pass): only on cross-president charts/strips */
  ...
  * {{ box-sizing:border-box; }}
  ...
  .rswitch {{ position:relative; display:inline-flex; background:#141414; border:1px solid var(--hair);
  ...
  .rknob {{ position:absolute; top:3px; bottom:3px; left:3px; width:calc(50% - 3px); background:#2a2c31;
  ...
  .detail-meta .vtoggle:hover {{ color:var(--primary); border-color:rgba(255,255,255,0.28); }}
