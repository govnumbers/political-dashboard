#!/usr/bin/env python3
"""Grocery prices (CPI food at home, year over year), Bureau of Labor Statistics via FRED (keyless).
...
(CUUR0000SAF11) is what Bureau of Labor Statistics headlines quote, differences are small and we say
which one we use.

Known permanent hole: Bureau of Labor Statistics never published October 2025 CPI (government
